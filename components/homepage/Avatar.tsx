...
const Avatar = () => {
  ...
  return (
    <div className="z-10 scale-100 transition-all duration-200 ease-out hover:z-0 hover:scale-[1.02]">
      <div style={style} className="rotate  overflow-hidden transition-all duration-200 ease-out">
