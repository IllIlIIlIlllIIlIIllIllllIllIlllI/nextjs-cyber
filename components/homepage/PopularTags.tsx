...
const PopularTags = () => {
  return (
    <div className="divide-gray-200 dark:divide-gray-700">
      <div className="dark:cyber-h light:cyber-h space-y-2 py-6 md:space-y-5">
      ...
      <div className="popular-tags grid grid-cols-3 gap-4 py-6 xl:grid-cols-6">
        {map(popularTags, (popularTag) => {
          ...
          const className = `${slug} cyber-tile-small flex w-[128px] justify-center space-x-2 rounded-lg p-3`;
