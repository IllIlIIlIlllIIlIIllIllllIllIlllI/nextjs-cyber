...
- Cloud Computing: 
  <div className="!m-0 text-sm italic ">AWS Certified Machine Learning - Specialty February 7, 2023.</div>
  <div className="!m-0 text-sm italic ">AWS Certified Cloud Practitioner at February 7, 2023.</div>
  <div className="!m-0 text-sm italic ">AWS Developer - Associate at February 7, 2023.</div>

- Cyber Security:
  <div className="!m-0 text-sm italic ">CompTIA Security+ February 7, 2023.</div>
